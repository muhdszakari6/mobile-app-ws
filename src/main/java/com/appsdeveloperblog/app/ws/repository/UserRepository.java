...
public interface UserRepository extends JpaRepository<UserEntity, Long> {
    ...
    @Query(value = "select * from Users u where and u.last_name = :lastName",
            nativeQuery = true)
    List<UserEntity> findUserByLastName(@Param("lastName")String lastName);

    @Query(value = "select u.first_name, u.last_name from Users u where and u.first_name LIKE %:lastName",
            nativeQuery = true)
    List<Object[]> findUsersByKeyword(@Param("lastName")String lastName);
